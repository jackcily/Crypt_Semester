  ...
  <div class="<?= $pageLayout['showRegFormOrNot'] ?>">
    <form action="register.php" method="post">
      ...
      <div class="form-group">
        ...
        <div class="form-group <?= $pageLayout['email-has-warning'] ?>">
          <label for="iEmail">邮箱</label>
          <input type="email" class="form-control" id="iEmail" name="Email" placeholder="请输入邮箱" autofocus required maxlength="128" value="<?= $_SESSION['Email'] ?>">
